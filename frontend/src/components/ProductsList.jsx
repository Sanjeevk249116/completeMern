    ...
    return (
      ...
      <div>
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight text-gray-800 hidden  sm:block">Product List</h1>
                ...
                <div key={product.id} className="group relative">
                  ...
                  <div className="mt-4 flex justify-between">
                    <div>
                      ...
                      <p className=" mt-1 text-sm text-red-800 ">{product.brand}</p>
                      <p className="widths mt-1 text-sm text-gray-500 ">{product.description}</p>
